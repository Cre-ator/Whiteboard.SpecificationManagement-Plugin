...
require_once ( __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'core' . DIRECTORY_SEPARATOR . 'specmanagement_config_api.php' );
require_once ( __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'core' . DIRECTORY_SEPARATOR . 'dmApi.php' );
...
if ( $option_change )
{
   ...
   dmApi::editPluginInWhiteboardMenu ( 'plugin_access_level', gpc_get_int ( 'AccessLevel', ADMINISTRATOR ) );
   ...
   dmApi::editPluginInWhiteboardMenu ( 'plugin_show_menu', gpc_get_int ( 'ShowMenu' ) );
